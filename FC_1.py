...
if __name__ == '__main__':
    ...
    [PeakIndices,Pfitness,C_Indices] = Pseduo_Peaks(DisC, Dist, DC_means,
                                                    DC_std,data,fitness,StdF,gamma, Var)
    fitness = oldfitness
    ...
    [FCluster,Ffitness,C_Indices] = Pseduo_Evolve(DisC, PeakIndices, PseDuoF, C_Indices, DC_means, DC_std, data, fitness, StdF, gamma)
    SF = FCluster
    Extract_FIndices = SF
